 ...
 *
 * Usage:
 * $download_remote_image = new Download_Remote_Image( $url );
...
class DownloadRemoteImage {
	 ...
	 * Constructor.
	 *
	 * @param string $url             The URL for the remote media.
	 *
	...
	private function is_supported_image_type( $mime_type ) {
		return in_array( $mime_type, array(
                'image/jpeg',
            	'image/gif',
            	'image/png',
            	'image/bmp',
	...
	private function get_extension_from_mime_type( $mime_type ) {
		$extensions = array(
        	...
        	// Audio formats
            'audio/mpeg'                   => '.mp3',
        	'audio/x-realaudio'            => '.mp3',
        	'audio/wav'                    => '.wav',
        	'audio/ogg'                    => '.ogg',
        	'audio/midi'                   => '.mp3',
        	'audio/x-ms-wma'               => '.wma',
        	'audio/x-ms-wax'               => '.mp3',
        	'audio/x-matroska'             => '.mp3',
		);
